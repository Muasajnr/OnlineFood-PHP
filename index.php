        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/tamasha.png"width="126"hieght="100" style="margin-top:0;"alt=""> </a>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Easiest way to order your favourite food among these top 6 dishes accross the globe from your comfortable place.</p>
                </div>
                <div class="row">
						<?php 					
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Rigathi Street,Buruburu,Nairobi Kenya</p>
                                    <h5>Phone: 07569696989</a></h5>
                                    <h5>Phone: +254 775092422</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>About Us</h5>
                                   <p>Have you ever thought of where you can taste a foreign country's food while still in your motherland? Worry no more Tamasha Shop gets you covered.We sell foods online and deliver them at your door step.Click on "Restaurant" (on top navigation bar) and order the food of your choice from the best restaurants accross the globe. </p>
                                </div>
                    </div>
                </div>
